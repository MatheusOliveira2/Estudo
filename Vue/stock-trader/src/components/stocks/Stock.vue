  ...
  <v-flex class="pr-3 pb-3" cs12 mb6 lg4>
    ...
    <v-card>
      <v-container fill-height>
        ...
        <v-btn class="green darken-3 white--text ml-1" @click="buyStock" :disabled=" insufficientFunds || quantity <= 0 || !Number.isInteger(quantity)">{{insufficientFunds? 'Insuficiente' : 'Comprar'}}</v-btn>
      </v-container>
    </v-card>
